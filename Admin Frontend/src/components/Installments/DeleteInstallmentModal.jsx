...
const DeleteInstallmentModal = ({ isOpen, onClose, onSubmit, installment }) => {
          ...
          <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                  Muddatli to'lovni o'chirish
                </Dialog.Title>
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Siz rostdan ham ushbu muddatli to'lovni o'chirmoqchimisiz? Bu amalni ortga qaytarib bo'lmaydi.
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                ...
                onClick={() => onSubmit(installment.id)}
              >
                O'chirish
              </button>
              <button
