                ...
                {seller.shopOwners && seller.shopOwners.length > 0 ? (
                  <div className="space-y-1">
                    {seller.shopOwners.map((shopOwner, index) => (
                      <div key={shopOwner.id} className="flex flex-col">
                        <div className="font-medium text-gray-900">{shopOwner.name}</div>
                        <div className="text-xs text-gray-500">{shopOwner.phone}</div>
                        {shopOwner.serviceAreas && shopOwner.serviceAreas.length > 0 && (
                          <div className="text-xs text-blue-600">
                            {shopOwner.serviceAreas.map(area => area.name).join(', ')}
                          </div>
                        )}
                      </div>
                    ))}
                  ...
                  <span className="text-gray-400">Bog'lanmagan</span>
                )}
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <button
