...
export default function SalesScreen() {
  ...
  const loadOrders = async () => {
    ...
    try {
      ...
      let url = `https://api.ttsa.uz/api/order-history?page=${pagination.currentPage}&limit=${pagination.perPage}`;
  ...
  const confirmCancelSale = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://api.ttsa.uz/api/seller-mobile/orders/${selectedSaleId}/cancel`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
