...
export default function SubcategoriesScreen() {
  ...
  const fetchSubcategories = async () => {
    setLoading(true);
    try {
      const url = `${API_MOBILE_URL}/category/${categoryId}?includeSubcategories=true`;
  ...
  const handleAddSubcategory = async () => {
    ...
    try {
      const response = await fetch(`${API_MOBILE_URL}/category/subcategory/create`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleEditSubcategory = async () => {
    ...
    try {
      const response = await fetch(`${API_MOBILE_URL}/category/subcategory/${editingSubcategory._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
          ...
          onPress: async () => {
            try {
              const response = await fetch(
                `${API_MOBILE_URL}/category/subcategory/${subcategoryId}`,
                {
                  method: 'DELETE',
                  headers: {
                    'Authorization': `Bearer ${token}`,
