...
const MENU_ITEMS: Array<{
  ...
  { name: 'notifications', label: 'Xabarnomalar', icon: 'notifications-outline' },
        ...
        {MENU_ITEMS.map((item) => {
          ...
          return (
            <DrawerItem
              ...
              rightIcon={item.name === 'notifications' && unreadCount > 0 ? (
          ...
          <ProtectedRoute>
            <Drawer
              screenOptions={{
                ...
                drawerStyle: [
                  {
                    width: isWeb ? (isDrawerOpen ? 280 : 0) : undefined,
                  },
                ],
                drawerType: 'front',
