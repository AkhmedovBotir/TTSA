...
const createProduct = async (req, res) => {
    try {
        const { name, price, originalPrice, category, subcategory, quantity, status, installmentDays } = req.body;
        ...
        const product = new Product({
            ...
            installmentDays: installmentDays || 0,
            createdBy: user._id,
    ...
    try {
        ...
        res.json({
            ...
            products: products.map(p => ({
                ...
                quantity: p.quantity,
                status: p.status,
                installmentDays: p.installmentDays,
...
const updateProduct = async (req, res) => {
    try {
        ...
        if (installmentDays !== undefined) updates.installmentDays = installmentDays;
        if (category) {
